function izabranoDost(ime){

	$.ajax({
		url: 'rest/por/izabranDostIzm',
		...
		success: function(data){
			...
			window.location.href="./mainPor.html";
				...
				window.location.href="./izlistavanjeVozila2.html";
			}
		}
	});
}
	...
	$.ajax({
		...
		success: function(v){
			...
			for(var i=0;i<v.length;i++){
				...
				preuzmi.setAttribute("onclick", "izabranoDost('"+v[i].korisnickoIme+"')");
				sad7.append(preuzmi);
